...
if __name__ == '__main__':
    ...
    model_path = './models'
    # model_name = 'MeshSegNet_Max_15_classes_72samples_lr1e-2_best.zip'  #more suitable for upper jaw
    # model_name = 'MeshSegNet_Man_15_classes_72samples_lr1e-2_best.zip' #more suitable for lower jaw   
    model_name = 'latest_checkpoint.tar' #last trained   

    mesh_path = './unseen dataset'  # need to modify
    sample_filenames = ['103979516_lprofile_occlusion_u.stl'] # need to modify
    # sample_filenames = ['176170042_lprofile_occlusion_u.stl'] # need to modify
    output_path = './outputs'
