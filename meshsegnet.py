...
#         iden = torch.eye(3).view(1, 9).repeat(batchsize, 1).to(x.device)
#         x = x + iden
#         x = x.view(-1, 3, 3)
#         return x
...
#         iden = torch.eye(self.k).view(1, self.k * self.k).repeat(batchsize, 1).to(x.device)
#         x = x + iden
#         x = x.view(-1, self.k, self.k)
#         return x
...
# class MeshSegNet(nn.Module):
#     def __init__(self, num_classes, num_channels=15, conv1_channels=64, conv2_channels=128, conv3_channels=256, k=16):
#         super(MeshSegNet, self).__init__()
#         self.num_classes = num_classes

#         # MLP-1
#         self.mlp1_conv1 = nn.Conv1d(num_channels, conv1_channels, 1)
#         self.mlp1_bn1 = nn.BatchNorm1d(conv1_channels)
#         self.mlp1_conv2 = nn.Conv1d(conv1_channels, conv1_channels, 1)
#         self.mlp1_bn2 = nn.BatchNorm1d(conv1_channels)

#         # MLP-2
#         self.mlp2_conv1 = nn.Conv1d(conv1_channels, conv2_channels, 1)
#         self.mlp2_bn1 = nn.BatchNorm1d(conv2_channels)
#         self.mlp2_conv2 = nn.Conv1d(conv2_channels, conv2_channels, 1)
#         self.mlp2_bn2 = nn.BatchNorm1d(conv2_channels)

#         # MLP-3
#         self.mlp3_conv1 = nn.Conv1d(conv2_channels, conv3_channels, 1)
#         self.mlp3_bn1_1 = nn.BatchNorm1d(conv3_channels)
#         self.mlp3_conv2 = nn.Conv1d(conv3_channels, conv3_channels, 1)
#         self.mlp3_bn1_2 = nn.BatchNorm1d(conv3_channels)
#         self.mlp3_conv3 = nn.Conv1d(conv3_channels, conv3_channels, 1)
#         self.mlp3_bn2_1 = nn.BatchNorm1d(conv3_channels)
#         self.mlp3_conv4 = nn.Conv1d(conv3_channels, conv3_channels, 1)
#         self.mlp3_bn2_2 = nn.BatchNorm1d(conv3_channels)

#         # Output layer
#         self.output_conv = nn.Conv1d(conv3_channels, num_classes, 1)
